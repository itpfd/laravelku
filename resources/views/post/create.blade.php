...
{{-- 
                            <div class="form-group">
                                <label for="title">Nama Wifi</label>
                            ...
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">id wifi</label>
                                <input type="text" class="form-control" id="id_wifi" name="id_wifi" placeholder="id wifi">
                              </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Nama wifi</label>
